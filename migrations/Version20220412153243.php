...
final class Version20220412153243 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE contrat_ended CHANGE mission mission LONGTEXT NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE noteperso noteperso LONGTEXT DEFAULT NULL COLLATE `utf8mb4_unicode_ci`');
